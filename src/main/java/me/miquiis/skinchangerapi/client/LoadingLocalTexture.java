...
@OnlyIn(Dist.CLIENT)
public class LoadingLocalTexture extends SimpleTexture {
   ...
   public LoadingLocalTexture(@Nullable File cacheFileIn, File imageFile, ResourceLocation textureResourceLocation, boolean legacySkinIn, @Nullable Runnable processTaskIn) {
         ...
         if (nativeimage != null) {
            ...
            this.future = CompletableFuture.runAsync(() -> {
               try {
                  ...
                  LOGGER.error("Couldn't load local texture " + imageFile);
                  return;
               }
